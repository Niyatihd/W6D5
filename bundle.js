...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/entryFile.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Time: "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, this.state.time.getHours(), " : ", this.state.time.getMinutes(), " : ", this.state.time.getSeconds(), "  ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "clock-date"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Date: "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, this.state.time.toDateString(), "  ")));
    }
  }]);
...
function (_React$Component) {
  ...
  _createClass(Weather, [{
    ...
    value: function fetchWeather(lat, lon) {
      return $.ajax({
        url: "http://api.openweathermap.org/data/2.5/weather?lat=".concat(lat, "&lon=").concat(lon),
        type: 'GET'
      }).then(function (res) {
    ...
    value: function getCoord() {
      ...
      function success(pos) {
        var that = this;
        var crd = pos.coords; // console.log(crd.latitude);

        var lat = Math.floor(crd.latitude);
        var lon = Math.floor(crd.longitude);
        return $.ajax({
          url: "http://api.openweathermap.org/data/2.5/weather?lat=".concat(lat, "&lon=").concat(lon, "&APPID=f816d7f39052e3a98b21952097a43076"),
          type: 'GET'
        }).then(function (res) {
    ...
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, this.state.temp);
    }
  }]);
